...
public enum DatabaseSingleton {
    ...
    public byte[] get(String key){ return _db.get(key.getBytes()); }
    public void set(String key, byte[] value){ _db.put(key.getBytes(), value); }
    public void set(String key, byte[] value, WriteOptions writeOptions){ _db.put(key.getBytes(), value,writeOptions); }
    public void delete(String key){_db.delete(key.getBytes());}
    public void delete(String key, WriteOptions writeOptions){_db.delete(key.getBytes(), writeOptions);}
}
